...
return [
    ...
    */
    ...
    'username' => 'O campo :attribute deve ser um nome de usuário válido.',
    'slug' => 'O campo :attribute deve ser um slug com apenas letras minúsculas, números e traços.',
    'game_auth' => 'O campo :attribute deve ser um nome de usuário :game válido.',
    ...
    | atributos usando a convenção "attribute.rule" para nomear as linhas. Isto
    | torna rápido especificar uma linha de idioma personalizada específica
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nosso
    | placeholder de atributo por algo mais amigável, como "Endereço de E‑mail"
